...
// scan message
	...
	if(suite.LDBC_SF==1) { filter_val = s62::Value::UBIGINT(2199029886840); }	// demo samsung
	if(suite.LDBC_SF==10) { filter_val = s62::Value::UBIGINT(58929); }
	if(suite.LDBC_SF==100) { filter_val = s62::Value::UBIGINT(19560); }
