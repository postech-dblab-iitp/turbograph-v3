...
class Schema {
   public:
    void setStoredTypes(std::vector<s62::LogicalType> types);
    void appendStoredTypes(std::vector<s62::LogicalType> types);
    std::vector<s62::LogicalType> getStoredTypes();
    std::vector<s62::LogicalType> &getStoredTypesRef();
   ...
   public:
    std::vector<s62::LogicalType> stored_types;
