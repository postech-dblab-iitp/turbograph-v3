...
class LHD {
 public:
  ...
  static constexpr timestamp_t ACCS_PER_RECONFIGURATION = 1000; // In my situation, trace will very short and reconfiguration overhead is relatively lower, compared to the query execution itself.
