...
cache_t *S4LRU_init(const common_cache_params_t ccache_params,
                    const char *cache_specific_params);

cache_t *LRU_SP_init(const common_cache_params_t ccache_params,
                     const char *cache_specific_params);

cache_t *LRU2_init(const common_cache_params_t ccache_params,
                    const char *cache_specific_params);
