...
#include "index/scan_state.hpp"

#include "index/art/art_key.hpp"
#include "index/art/leaf.hpp"
#include "index/art/node.hpp"
#include "index/art/node4.hpp"
#include "index/art/node16.hpp"
...
public:
	...
	ART(const vector<column_t> &column_ids, IndexConstraintType constraint_type);
	~ART() override;
