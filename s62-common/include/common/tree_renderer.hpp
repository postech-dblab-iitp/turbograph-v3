...
public:
	...
	string ToString(const CypherPhysicalOperator &op);
	string ToString(const QueryProfiler::TreeNode &op);
	string ToString(const CypherPipeline &op);

	// void Render(const LogicalOperator &op, std::ostream &ss);
	void Render(const CypherPhysicalOperator &op, std::ostream &ss);
	void Render(const QueryProfiler::TreeNode &op, std::ostream &ss);
	void Render(const CypherPipeline &op, std::ostream &ss);
...
private:
	...
	unique_ptr<RenderTree> CreateTree(const CypherPhysicalOperator &op);
	unique_ptr<RenderTree> CreateTree(const QueryProfiler::TreeNode &op);
	unique_ptr<RenderTree> CreateTree(const CypherPipeline &op);
	...
	unique_ptr<RenderTreeNode> CreateNode(const CypherPhysicalOperator &op);
