...
#include "common/single_thread_ptr.hpp"
...
enum class LogicalTypeId : uint8_t {
	...
	// refer to /s62/s62-compiler/kuzu/include/kuzu/common/types/types.h
...
public:
	...
	DUCKDB_API static LogicalType PATH( LogicalType child);                       // NOLINT
