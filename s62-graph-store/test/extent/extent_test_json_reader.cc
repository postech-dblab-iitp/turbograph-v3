...
TEST_CASE ("Json Reader Open File & Read Test", "[tile]") {
  ...
  reader.InitJsonFile("/home/tslee/s62/s62-graph-store/test/extent/person_0_0.json.original", GraphComponentType::VERTEX);
...
int main(int argc, char **argv) {
  ...
  DiskAioParameters::WORKSPACE = "/home/tslee/s62/s62-graph-store/test/extent/data/";
